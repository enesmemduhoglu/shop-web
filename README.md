...
* **AWS S3**: Dosya / görsel yükleme
* **Mail**: SMTP mail gönderimi
* **JWT**: Kimlik doğrulama ve yetkilendirme için kullanılır
...
* `REACT_APP_API_URL` backend servis adresini belirtir
* `REACT_APP_` prefix'i React tarafından zorunludur
